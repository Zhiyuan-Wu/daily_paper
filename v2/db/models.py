...
class AppProfile(Base):
    ...
    default_sources_json: Mapped[str] = mapped_column(Text, default='["openalex"]')
    recommend_strategy_weights_json: Mapped[str] = mapped_column(Text, default='{"keyword_semantic":0.25,"interested_semantic":0.25,"repetition_penalty":0.25,"llm_theme":0.25}')
